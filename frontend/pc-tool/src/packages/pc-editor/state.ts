...
function getDefaultConfig(): IConfig {
    return {
        ...
        openIntensity: false,
        pointAutoNormalize: false,
        pointLayerMode: 'both',
        brightness: 1,
        lidarOpacity: 1,
        radarOpacity: 1,
        radarColorMode: ColorModeEnum.HEIGHT,
        radarOpenIntensity: false,
        radarAutoNormalize: false,
        radarHasIntensity: false,
        radarHasSnr: false,
        radarIntensity: [0, 255],
        radarIntensityRange: [0, 255],
        radarEdgeColor: ['#000dff', '#ff0000'],
        radarSingleColor: '#87abff',
        radarPointHeight: [-Infinity, Infinity],
        pointGround: -1.5,
